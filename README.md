...
“My Work” contains the BridgeFund story organised by year, introduced by a short explanation of its practical lessons and purpose. Years one through four contain six, nine, seven and six chapters respectively, each with a recap. Year four is explicitly in progress and closes with a reflection across the whole story. Native HTML details and summary elements make every year and chapter expandable with mouse, touch or keyboard, without JavaScript. All years and chapters are collapsed on initial load.
